...
def urinalysis(CaptImg):
    ...
    ExtCntrsCpy = np.array(ExtCntrs, dtype=object)
    ...
    for i in range(StripColorCount):
        ...
        if i == 0:
            if IdxMatch == 0:   result['LEUKOCYTES'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['LEUKOCYTES'] = '15 TRACE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['LEUKOCYTES'] = 'POSITIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['LEUKOCYTES'] = 'TRACE 75. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['LEUKOCYTES'] = 'MODERATE 125. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['LEUKOCYTES'] = 'LARGE 500. Match Index: {}'.format(IdxMatch)

        elif i == 1:
            if IdxMatch == 0:   result['NITRITE'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['NITRITE'] = 'POSITIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['NITRITE'] = 'POSITIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['NITRITE'] = 'POSITIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['NITRITE'] = 'POSITIVE. Match Index: {}'.format(IdxMatch)

        elif i == 2:
            if IdxMatch == 0:   result['UROILINOGEN'] = '3.2 NORMAL. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['UROILINOGEN'] = '16 NORMAL. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['UROILINOGEN'] = '32 +. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['UROILINOGEN'] = '64 ++. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['UROILINOGEN'] = '128 +++. Match Index: {}'.format(IdxMatch)

        elif i == 3:
            if IdxMatch == 0:   result['PROTEIN'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['PROTEIN'] = 'TRACE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['PROTEIN'] = '0.3 +. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['PROTEIN'] = '1.0 ++. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['PROTEIN'] = '3.0 +++. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['PROTEIN'] = '>= 20 ++++. Match Index: {}'.format(IdxMatch)

        elif i == 4:
            if IdxMatch == 0:   result['PH'] = '5.0. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['PH'] = '6.0. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['PH'] = '6.5. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['PH'] = '7.0. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['PH'] = '7.5. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['PH'] = '8.0. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 6: result['PH'] = '8.5. Match Index: {}'.format(IdxMatch)

        elif i == 5:
            if IdxMatch == 0:   result['BLOOD'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['BLOOD'] = 'NON-HEMOLYZED TRACE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['BLOOD'] = '10 TRACE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['BLOOD'] = '25 SMALL. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['BLOOD'] = '80 MODERATE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['BLOOD'] = '200 LARGE. Match Index: {}'.format(IdxMatch)

        elif i == 6:
            if IdxMatch == 0:   result['SP. GRAVITY'] = '1.000. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['SP. GRAVITY'] = '1.005. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['SP. GRAVITY'] = '1.010. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['SP. GRAVITY'] = '1.015. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['SP. GRAVITY'] = '1.020. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['SP. GRAVITY'] = '1.025. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 6: result['SP. GRAVITY'] = '1.030. Match Index: {}'.format(IdxMatch)

        elif i == 7:
            if IdxMatch == 0:   result['KETONE'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['KETONE'] = 'TRACE 0.5 . Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['KETONE'] = 'SMALL 1.5 . Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['KETONE'] = 'MODERATE 4.0 . Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['KETONE'] = 'LARGE 8.0. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['KETONE'] = 'LARGE 16.0. Match Index: {}'.format(IdxMatch)

        elif i == 8:
            if IdxMatch == 0:   result['BILIRUBIN'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['BILIRUBIN'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['BILIRUBIN'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['BILIRUBIN'] = 'SMALL 17. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['BILIRUBIN'] = 'MODERATE 50. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['BILIRUBIN'] = 'LARGE 100. Match Index: {}'.format(IdxMatch)

        elif i == 9:
            if IdxMatch == 0:   result['GLUCOSE'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 1: result['GLUCOSE'] = 'NEGATIVE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 2: result['GLUCOSE'] = '5 TRACE. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 3: result['GLUCOSE'] = '15 +. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 4: result['GLUCOSE'] = '30 ++. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 5: result['GLUCOSE'] = '60 +++. Match Index: {}'.format(IdxMatch)
            elif IdxMatch == 6: result['GLUCOSE'] = '110 ++++. Match Index: {}'.format(IdxMatch)

    return result
########################################### MAIN CODE STARTS FROM HERE ###########################################
def fun(x):
    CaptImg = cv.cvtColor(cv.imread(x), cv.COLOR_BGR2RGB)
    res= urinalysis(CaptImg)
    return res